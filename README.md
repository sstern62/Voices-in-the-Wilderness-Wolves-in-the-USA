...
Below are the paragraphs generated by **NLTK's** _new_text.generate(length=100, text_seed=None, random_seed=42)_, which serves as my unbiased summaries and visualizations of the data. These can also be found in the appropriate **Python** nottebooks. These were my main sources for drawing my conclusions, with only Oregon needing to be supplemented by other NLTK tools.
